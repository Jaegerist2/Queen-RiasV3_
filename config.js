...
module.exports = {
    ...
    ownerName: process.env.OWNER_NAME || "SHINGEKI", // Owner name

    ownerNumber: process.env.OWNER_NUMBER || "2349014805359", // Your WhatsApp number

    sudo: process.env.SUDO ? process.env.SUDO.split(",") : ["2348165846414"," 2349014805359"], // People Who can use the bot even in Private mode
